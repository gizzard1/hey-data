                                        ...
                                        <div class="contact-form">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    @error('name') <span class="text-danger">*Corrige este campo* </span> @enderror
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <input  wire:model="mail" type="text" placeholder="Correo Electronico" style="background-color: rgba(250,250,250,0.3);">
                                                    @error('mail') <span class="text-danger">*Corrige este campo* </span> @enderror
                                                </div>
                                                <div class="col-lg-12">
                                                    <textarea maxlength="300" wire:model="message" rows="6" placeholder="Mensaje" style="background-color: rgba(250,250,250,0.3);"></textarea>
                                                    @error('message') <span class="text-danger">*Corrige este campo* </span> @enderror
                                                </div>
                                                <div class="col-lg-12">
                                                    <button class="nav-item nav-link" style="background-color: #1d3557;color: white;" wire:click="store">¡Escríbenos!</button>
                                                </div>
                                            </div>
                                        </div>
