...
<span class="float-right"><a class="details" data-dismiss="modal" wire:click="deleteMov">Eliminar Cita</a></span>
</div>
    ...
    <table class="table table-responsive-md table-hover  text-center">
        ...
        <tbody>
            @foreach($itemSelected->details as $detail)
                <tr>
                    <td>{{ $detail->servicio->name }}</td>
                    <td>{{ $detail->servicio->duration }} min.</td>
...
<div class="table-responsive">
    <table class="table table-responsive-md table-hover  text-center">
        ...
        <tbody>
            @foreach($itemSelected->details_product as $detail)
                <tr>
