...
class Ventas extends Component
{
    ...
    protected $listeners = [
        ...
        'removeItemCart',
        'enviarDetalles' => 'recibirDetalles',
        'clear-cart' => 'clear',
        'clear-cart-pv' => 'clear',
        'generatedPoints',
        'aperturaCaja',
        ...
        'initializeTomSelect',
        'recalculate',
        'enviarMovimiento' => 'recibirMovimiento',
        'GCInCart' => 'inCart',
        'setCajaChica'
    ];
    ...
    public function render()
    {
        try {
            ...
            $data = [
                ...
                'isAdmin' => $isAdmin,
                'salonNameIsNull' => $salonNameIsNull,
                'propinasRecibidas' => $this->totalPropinas(),
                'propinas' => $propinas,
            ];
            if ($this->constrained) {
            ...
            if (!$GCInMethods) {
                ...
                $coll = collect(
                    [
                        ...
                        'name' => $product->name,
                        'sku' => $product->sku,
                        'reward_points' => $reward_points ? floatval($reward_points) : floatval(DRG::calculateRewardPoints($pid, false, $total, null, session()->has('customerId') ? session('customerId') : null, Auth::user()->salon->recompensaGeneral()->first())),
    ...
    function updateQty($uid, $cant = 1, $product_id = null)
    {
        try {
            ...
            $newItem['reward_points'] = DRG::calculateRewardPoints($newItem['pid'], false, $values['total'], null, session()->has('customerId') ? session('customerId') : null, Auth::user()->salon->recompensaGeneral()->first());
